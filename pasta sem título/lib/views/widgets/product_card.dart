...
class _ProductCardState extends State<ProductCard> {
  ...
  Widget _buildProductImage(Product product, {BoxFit fit = BoxFit.cover}) {
    ...
    final url = Uri.parse(base).resolve(relativePath).toString();
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                foregroundColor:
                    product.inStock ? Colors.black : FratheliColors.text3,
                shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(999)),
              ),
              child:
                  Text(product.inStock ? 'Adicionar ao carrinho' : 'Esgotado'),
            ),
          ),
        ],
      ),
